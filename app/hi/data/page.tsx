...
const t = {
  title: 'ट्रेंड डेटा',
  description: 'सूचित भविष्यवाणी करने के लिए प्रवृत्तियों और ऐतिहासिक डेटा का विश्लेषण करें।',
  subtitle: 'डेटा-संचालित प्रवृत्तियां',
};

const articles = getArticles('hi', 'data');
