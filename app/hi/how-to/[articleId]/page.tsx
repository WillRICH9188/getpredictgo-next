...
export default async function ArticlePage({ params }: { params: Promise<{ articleId: string }> }) {
  ...
  const article = getArticle('hi', 'how-to', articleId);
  const allArticles = getArticles('hi', 'how-to');
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/hi/how-to" className="text-blue-400 hover:text-blue-300">
              Return to कैसे खेलें
            </Link>
          </div>
        </div>
      </div>
      ...
      <main className="flex-1">
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-6">
          <div className="flex items-center gap-2 text-sm text-slate-400">
            <Link href="/hi" className="hover:text-blue-400">Predict Go</Link>
            <span>/</span>
            <Link href="/hi/how-to" className="hover:text-blue-400">कैसे खेलें</Link>
            <span>/</span>
        ...
        <article className="max-w-4xl mx-auto px-4 md:px-6 py-8">
          ...
          {relatedArticles.length > 0 && (
            <div className="mt-16 pt-12 border-t border-slate-700/50">
              <h2 className="text-2xl font-bold mb-8">संबंधित लेख</h2>
