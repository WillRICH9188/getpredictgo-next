...
const t = {
  title: 'राजनीति',
  description: 'दुनिया भर की भविष्यवाणी बाजारों से चुनाव की भविष्यवाणी, राजनीतिक परिणाम और शासन संबंधी पूर्वानुमान।',
  subtitle: 'राजनीतिक पूर्वानुमान',
};
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
        <div className="flex items-center gap-2 text-sm text-slate-400">
          ...
          <span>/</span>
          <span className="text-blue-400">राजनीति</span>
        </div>
      </div>
      ...
      <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 md:px-6 w-full flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            ...
            <h3 className="text-xl font-bold mb-3">चुनाव</h3>
            <p className="text-slate-300 leading-relaxed">
              दुनिया भर के प्रमुख चुनावों पर भविष्यवाणी, राष्ट्रपति, संसदीय और क्षेत्रीय प्रतियोगिताएं।
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">🏛️</div>
            <h3 className="text-xl font-bold mb-3">विधान परिणाम</h3>
            <p className="text-slate-300 leading-relaxed">
              विधेयक पारित होने, संसदीय नियंत्रण और नीति निर्णयों पर भविष्यवाणी।
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">🤝</div>
            <h3 className="text-xl font-bold mb-3">राजनीतिक घटनाएं</h3>
            <p className="text-slate-300 leading-relaxed">
              सरकारी इस्तीफे, गठबंधन निर्माण और अन्य प्रमुख राजनीतिक विकास पर भविष्यवाणी।
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">🌍</div>
            <h3 className="text-xl font-bold mb-3">वैश्विक राजनीति</h3>
            <p className="text-slate-300 leading-relaxed">
              अंतरराष्ट्रीय संबंध, प्रतिबंध, संधि और राजनयिक परिणामों पर भविष्यवाणी।
            </p>
          </div>
        </div>
      </section>
