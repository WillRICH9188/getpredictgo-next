...
const t = {
  title: 'राजनीति',
  description: 'डेटा-संचालित अंतर्दृष्टि के साथ राजनीतिक घटनाओं और भविष्यवाणियों का विश्लेषण करें।',
  subtitle: 'राजनीतिक विश्लेषण',
};

const articles = getArticles('hi', 'politics');
