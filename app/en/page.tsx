    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-950 via-blue-950/20 to-slate-950 text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-blue-500/20 bg-slate-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex justify-between items-center">
          <a href="/en" className="text-2xl md:text-3xl font-bold tracking-tight hover:opacity-80 transition-opacity">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mt-16 grid grid-cols-3 gap-4 md:gap-8">
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-slate-400 mt-2">Languages</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-blue-400">100%</div>
                <div className="text-xs md:text-sm text-slate-400 mt-2">Free Access</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-cyan-400">Live</div>
                <div className="text-xs md:text-sm text-slate-400 mt-2">Market Data</div>
              </div>
            </div>
          </div>
        </section>
