...
const sampleArticles = [
  {
    id: 1,
    title: 'Bitcoin Price Predictions: What Markets Expect in 2026',
    description: 'Analysis of crypto prediction markets showing Bitcoin trajectory predictions for the coming year.',
    category: 'Finance',
  ...
  {
    id: 2,
    title: '2026 U.S. Election: Early Odds and Market Insights',
    description: 'Comprehensive breakdown of prediction market odds for the upcoming presidential election.',
    category: 'Politics',
  ...
  {
    id: 3,
    title: 'Can Argentina Win the World Cup Again?',
    description: 'Sports prediction markets analyze Argentina\'s chances in the upcoming tournament.',
    category: 'Sports',
      ...
      <header className="sticky top-0 z-50 border-b border-slate-700/50 bg-slate-950/90 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <nav className="border-t border-slate-700/50 py-4 relative flex items-center">
            ...
            <div className="md:hidden w-12 flex-shrink-0 flex items-center justify-center text-blue-400 text-2xl pointer-events-none">
              ❮
            </div>

            {/* Scrollable navigation area - flex-1 fills middle space */}
            <div className="flex-1 flex gap-6 md:gap-8 text-sm md:text-base whitespace-nowrap overflow-x-auto">
              {categories.map((cat) => (
                <a
                  key={cat.name}
                  href={cat.href}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-3 gap-4 md:gap-8">
            <div className="text-center">
              ...
              <div className="text-sm md:text-base text-slate-400">Languages</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-blue-400 mb-2">100%</div>
              <div className="text-sm md:text-base text-slate-400">Free Access</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-cyan-400 mb-2">Live</div>
              <div className="text-sm md:text-base text-slate-400">Market Data</div>
            </div>
          </div>
        </div>
      </section>
