...
const t = {
  title: 'Politics',
  description: 'Analyze political events and predictions with data-driven insights.',
  subtitle: 'Political analysis and predictions',
};

const articles = getArticles('en', 'politics');
