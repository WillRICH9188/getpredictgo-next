...
export default async function ArticlePage({ params }: { params: Promise<{ articleId: string }> }) {
  ...
  const article = getArticle('en', 'data', articleId);
  const allArticles = getArticles('en', 'data');
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/en/data" className="text-blue-400 hover:text-blue-300">
              Return to Trend Data
            </Link>
          </div>
        </div>
      </div>
      ...
      <main className="flex-1">
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-6">
          <div className="flex items-center gap-2 text-sm text-slate-400">
            ...
            <span>/</span>
            <Link href="/en/data" className="hover:text-blue-400">Trend Data</Link>
            <span>/</span>
