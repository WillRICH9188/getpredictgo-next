...
const t = {
  title: '政治',
  description: '全球预测市场的选举预测、政治成果和治理相关预测。',
  subtitle: '政治预测',
};
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
        <div className="flex items-center gap-2 text-sm text-slate-400">
          ...
          <span>/</span>
          <span className="text-blue-400">政治</span>
        </div>
      </div>
      ...
      <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 md:px-6 w-full flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            ...
            <h3 className="text-xl font-bold mb-3">选举</h3>
            <p className="text-slate-300 leading-relaxed">
              对全球主要选举的预测，包括总统、议会和地区性竞赛。
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">🏛️</div>
            <h3 className="text-xl font-bold mb-3">立法成果</h3>
            <p className="text-slate-300 leading-relaxed">
              关于法案通过、国会控制权和全球立法机构政策决定的预测。
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">🤝</div>
            <h3 className="text-xl font-bold mb-3">政治事件</h3>
            <p className="text-slate-300 leading-relaxed">
              对政府辞职、联盟形成和其他重大政治发展的预测。
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">🌍</div>
            <h3 className="text-xl font-bold mb-3">全球政治</h3>
            <p className="text-slate-300 leading-relaxed">
              国际关系预测，包括制裁、条约和外交成果。
            </p>
          </div>
