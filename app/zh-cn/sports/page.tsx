...
const t = {
  title: '体育',
  description: '全球主要体育赛事、锦标赛和运动竞赛的预测市场。',
  subtitle: '主要体育预测',
};
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
        <div className="flex items-center gap-2 text-sm text-slate-400">
          ...
          <span>/</span>
          <span className="text-blue-400">体育</span>
        </div>
      </div>
      ...
      <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 md:px-6 w-full flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            ...
            <h3 className="text-xl font-bold mb-3">世界杯</h3>
            <p className="text-slate-300 leading-relaxed">
              对国际足联世界杯的预测，包括锦标赛赢家、决赛队伍和个人运动员成就。
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">🏀</div>
            <h3 className="text-xl font-bold mb-3">篮球</h3>
            <p className="text-slate-300 leading-relaxed">
              NBA预测涵盖赛季冠军、季后赛成果和个人球员表现。
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">🏈</div>
            <h3 className="text-xl font-bold mb-3">美式橄榄球</h3>
            <p className="text-slate-300 leading-relaxed">
              超级碗预测和美式职业橄榄球联赛的赛季及季后赛预测。
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">⚾</div>
            <h3 className="text-xl font-bold mb-3">其他体育</h3>
            <p className="text-slate-300 leading-relaxed">
              网球、板球、拳击、自行车赛和其他全球体育赛事。
            </p>
          </div>
        </div>
      </section>
