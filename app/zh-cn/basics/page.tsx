      ...
      <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 md:px-6 w-full flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            ...
            <h3 className="text-xl font-bold mb-3">什么是预测市场？</h3>
            <p className="text-slate-300 leading-relaxed">
              探索预测市场如何运作、其历史以及为什么它们是理解未来事件的有价值工具。
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">📊</div>
            <h3 className="text-xl font-bold mb-3">理解赔率</h3>
            <p className="text-slate-300 leading-relaxed">
              掌握预测市场中使用的不同赔率制度，包括小数赔率、分数赔率及其与概率的关系。
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            ...
            <p className="text-slate-300 leading-relaxed">
              进入预测市场的首步。了解账户设置、市场选择和首次预测下注。
            </p>
          </div>

          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300">
            <div className="text-4xl mb-4">💡</div>
            <h3 className="text-xl font-bold mb-3">常见错误</h3>
            <p className="text-slate-300 leading-relaxed">
              从他人的经验中学习。了解参与预测市场时的常见陷阱和误解。
            </p>
          </div>
        </div>
      </section>
